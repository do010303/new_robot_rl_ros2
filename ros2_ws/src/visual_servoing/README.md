...
### 4. Running Digital Twin with Raspberry Pi (Sim-to-Real)
To mirror the simulation movements to the physical 4-DOF robot without Wi-Fi multicast errors, you must use the **FastDDS Discovery Server**.
...
**On the Laptop (Python Control Terminal):**
```bash
cd ~/new_rl_ros2/ros2_ws
source install/setup.bash
unset RMW_IMPLEMENTATION
